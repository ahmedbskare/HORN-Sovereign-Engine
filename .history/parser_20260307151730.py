...
import time
import thermal # pyright: ignore[reportMissingImports]
import SovereignRegistry # pyright: ignore[reportMissingImports]
import secrets
...
link = HornHardwareBridge() # type: ignore
...
class HornHardwareBridge:
    ...
    async def connect_to_device(self, device_id, port):
        ...
        handshake_token = hmac.new(SovereignRegistry.SovereignRegistry.ADMIN_KEY.encode(), 
